...
\begin{figure}
    ...
    \caption{Comparison between Python and OpenCL performance for simple model}
\end{figure}
...
n datapoints of q results in
having to calculate the scattering for q squared .
we have that we are actually 
¨
